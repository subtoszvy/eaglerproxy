...
(function (Util) {
    ...
    function areDomainsEqual(d1, d2) {
        ...
        if (parseResult1.type != ParseResultType.Invalid &&
            ...
            else if (parseResult1.type == ParseResultType.NotListed &&
                parseResult2.type == ParseResultType.NotListed) {
                if (parseResult1.labels[0] ==
                    "WILDCARD-LOL-EXTRA-LONG-SUBDOMAIN-TO-LOWER-CHANCES-OF-COLLISION") {
                    // wildcard
            ...
            else if (parseResult1.type == ParseResultType.Reserved &&
                parseResult2.type == ParseResultType.Reserved) {
                if (parseResult1.hostname == "" &&
